...
json_file_deals = open(os.path.join(sys.path[0], "semi_refined_data/Gold/deals_sells_Gold.json"), "r")
json_file_orders = open(os.path.join(sys.path[0], "semi_refined_data/Gold/orders_sells_Gold.json"), "r")
